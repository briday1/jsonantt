...
export const STYLE_OPTIONS = [
  ...
  n('task_number_start', 'Starting task number', 1, 'Labels and display', 'First top-level number across charts and tables. For 5: 5, 5.1, 5.2, 6… IDs and M1 milestone labels are unchanged.', 0, undefined, '1'),
  ...
  b('number_milestones', 'Number milestones', false, 'Milestones', 'Gantt and Table labels and markers. Defaults to M1, M2, …'),
  n('milestone_number_start', 'Starting milestone number', 1, 'Milestones', 'Independent of task numbering. Used when Number milestones is enabled.', 0, undefined, '1'),
  {...t('milestone_prefix', 'Milestone number prefix', 'M', 'Milestones', 'M, another letter or text, or leave empty for numbers only. Reset restores M.'), allowEmpty: true},
